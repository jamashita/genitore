...
describe('Alive', () => {
  describe('get', () => {
    it('returns the inner value', () => {
      const alive1 = Alive.of(1);
      const alive2 = Alive.of(0);
      const alive3 = Alive.of(-1);
      const alive4 = Alive.of('');
      const alive5 = Alive.of('1');
      const alive6 = Alive.of(true);
      const alive7 = Alive.of(false);
